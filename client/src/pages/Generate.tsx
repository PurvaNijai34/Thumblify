...
import { colorSchemes, type AspectRatio, type IThumbnail, type ThumbnailStyle, aspectRatios } from '../assets/assets';
...
const Generate = () => {
  ...
  const [colourSchemeId, setColorSchemeId] = useState<string>(colorSchemes[0].id);
  ...
  const handleGenerate = async () => {
    ...
    try {
      const api_payload = {
        ...
        color_scheme: colourSchemeId, // ✅ FIXED
        text_overlay: true,
      };
      ...
      if (data.thumbnail) {
        ...
        navigate("/generate/" + data.thumbnail._id); // ✅ FIXED
      }
    } catch (error: any) {
      console.error(error);
            ...
            <div className={`space-y-6 ${id && 'pointer-events-none'}`}>
              ...
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  {/* colorSchemeSelector */}
                  <ColorSchemeSelector value={colourSchemeId} onChange={setColorSchemeId} />
...
">{
                      ...
                      loading ? 'Generting...' : 'Generate Thumbnail'
                    }</button>
                )}
              </div>
            </div>
            {/* Right panel */}
            <div>
              <div className="p-6 rounded-2xl bg-ewhite/8 border-white/10 shadow-xl">
