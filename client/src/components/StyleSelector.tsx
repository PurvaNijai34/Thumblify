...
const StyleSelector = ({ value, onChange, isOpen, setIsOpen }: { value: ThumbnailStyle; onChange: (style: ThumbnailStyle) => void; isOpen: boolean; setIsOpen: (isOpen: boolean) => void }) => {
    ...
    const styleDescriptions: Record<ThumbnailStyle, string> = {
        "Bold & Graphic": "High contrast, bold typography, vibrant colors.",
      ...
      "Illustrated": "Hand-drawn or digitally illustrated style",
        "Tech/Futuristic": "Retro typewriter font with a vintage feel",
    }
    ...
    return (
        <div className="relative space-y-3 dark">
            <label className="block text-sm font-medium text-zinc-200">Thumbnil Style</label>
            <button
                type="button"
